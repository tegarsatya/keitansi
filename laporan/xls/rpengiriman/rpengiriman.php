...
<?php
	...
	header("content-disposition:attachment; filename=report_pengiriman_barang_a.xls");
...
?>
    <head>
        ...
        <title>Report Pengiriman Kurir</title>
    </head>
    ...
    <body>
		<table>
        	<tr>
            	<th colspan="18">REPORT PENGIRIMAN KURIR</th>
            </tr>
            <tr>
            	<td colspan="18"></td>
            </tr>
    	...
    	<table border="1">
          ...
          <td><center><?php echo($hasil['id_out']); ?></center></td>
          ...
          <td><center><?php echo($hasil['nama_adm']); ?></center></td>
					...
					<td><center><?php echo($hasil['status_tfkk']); ?></center></td>
				</tr>
			<?php $nomor++; } ?>
            </tbody>
        </table>
