            ...
            <div style="width:45%; display:inline-block; float:right;">
                ...
                <table width="80%" style="font-size:12px;">
                    <tr>
                        ...
                        <td></td>
                        <td><div align="right"><span style="float:left;">Rp.</span>0</div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><div align="right"><span style="float:left; font-weight:bold;">Rp.</span><b>0</b></div></td>
                    </tr>
                </table>
                </div>
            	<div style="min-height:30px; height:auto; border:solid 1px #666666; text-align:center; font-weight:bold; margin-top:10px; padding:5px; font-size:12px;">Terbilang : # Rupiah #</div>
