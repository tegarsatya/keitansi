<?php
	...
	if ($secu->validadmin($admin, $kunci)==false) {
		...
		//SAVE
		$save	= $conn->prepare("INSERT INTO transaksi_faktur_kirim VALUES(:id_tfkk, :id_tfk, :id_out, :tgl_tfk, :ket_tfkk, :status_tfkk, :catat, :admin, :catat, :admin)");
		$save->bindParam(':id_tfkk', $id_tfkk, PDO::PARAM_STR);
