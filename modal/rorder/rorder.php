        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="masuk" class="form-control" onkeyup="angka(this)" value="<?php echo($data->angka($view['jumlah_trd'])); ?>" onchange="sumitemrorderr()" placeholder="0" required="required" />
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="sisa" class="form-control" onkeyup="angka(this)" value="<?php echo($data->angka($view['sisa_psd'])); ?>" onchange="sumitemrorderr()" placeholder="0" required="required" />
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="harga" id="harga" class="form-control" onkeyup="angka(this)" onchange="sumitemrorderr()" placeholder="0" required="required" />
                </div>
                <div class="form-group col-md-6">
                    <label>Diskon<span class="tx-danger">*</span></label>
                    <input type="text" name="diskon" id="diskon" class="form-control" onchange="sumitemrorderr()" placeholder="0" required="required" />
                    <div id="imgloading"></div>
                </div>
                <div class="form-group col-md-6">
