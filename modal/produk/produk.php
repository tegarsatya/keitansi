        ...
        <div class="modal-body">
            ...
            <div class="form-group col-md-6">
                 ...
                 <div class="form-group col-md-6">
                    ...
                    <input type="text" name="no_nie" class="form-control" placeholder="Masukan Nomer NIE" required="required" />
                </div>
                <div class="form-group col-md-6">
                    <label>Kode Produk Internal <span class="tx-danger">*</span></label>
                    <input type="text" name="new_code" class="form-control" placeholder="kode Produk Internal" required="required" />
                </div>
			</div>
...
<?php
		...
		$read	= $conn->prepare("SELECT kode_pro, nama_pro, berat_pro, id_kpr, id_spr, rak_pro, section_pro, minstok_pro, kode_produk_jadi, kategori_obat, no_nie, tgl_nie, new_code FROM produk WHERE id_pro=:kode");
...
?>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label>Kode Produk Internal <span class="tx-danger">*</span></label>
                    <input type="text" name="new_code" class="form-control" value="<?php echo($view['new_code']); ?>" placeholder="Kode Produk Internal" required="required" />
                </div>
			</div>
