<div class="content-header">
    <div>
        ...
        <h4 class="content-title">Detail Data - Rute pengiriman Barang dan Tuker faktur</h4>
    </div>
</div>
<div class="content-body">
    <h1>Rute Pengiriman Barang</h1>
    <div class="table-responsive">
            <table>
                    <thead>
                        <tr>
                            <th>Nama Pengirim</th>
                            <th><center>Nomor Faktur Pengiriman Barang</center></th>
                    ...
                    <?php
                        ...
                        $master	= $conn->prepare("SELECT A.id_rute, A.nama_pengirim, A.tanggal, B.barang, B.id_rute FROM rute AS A LEFT JOIN rute_pengiriman_barang AS B ON A.id_rute=B.id_rute WHERE A.id_rute=:kode");
