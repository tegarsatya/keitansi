        ...
        <div class="signin-panel">
            ...
            <div class="signin-sidebar">
                <div class="signin-sidebar-body">
                   <a href="#" class="sidebar-logo mg-b-0"><span>DUA FARMA </span></a>
                    ...
                    <a href="#" class="sidebar-logo mg-b-0"><span>TRACKING SYSTEM </span></a>
                    <h5 class="signin-subtitle">Please signin to continue.</h5>
                    <form action="#" method="post" id="formlogin" autocomplete="off">
                    <div class="signin-form">
                        <div class="form-group">
                            <label>ID address</label>
                            <input type="text" name="emailz" id="emailz" class="form-control" placeholder="Enter your email address" required="required" />
                        </div>
                        ...
                        <a href="<?="http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']?>" class="btn btn-light btn-uppercase btn-block">Kembali Ke Menu Awal</a>
						<!--
                        <div class="divider-text mg-y-30">Or</div>    
